...
if [ "$CIRCLE_BRANCH" == "production" ]; then
  ...
  # Day Labor
  EMAIL_DAY_LABOR="$EMAIL_DAY_LABOR_PROD"
  EMAIL_DAY_LABOR_REPLYTO="$EMAIL_DAY_LABOR_REPLYTO_PROD"
  ...
  # Day Labor
  EMAIL_DAY_LABOR="$EMAIL_DAY_LABOR_STAGING"
  EMAIL_DAY_LABOR_REPLYTO="$EMAIL_DAY_LABOR_REPLYTO_STAGING"
else # for PR builds
  # Common
  DEPLOYMENT_MODE="dev"
