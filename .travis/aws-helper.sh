...
function backend_set_env_vars {
  ...
  if [ "${DEPLOYMENT_MODE}" == "PRODUCTION" ]; then
    EMAIL_ADDRESS_APD=$EMAIL_ADDRESS_APD_PROD
    EMAIL_ADDRESS_OPO=$EMAIL_ADDRESS_OPO_PROD
    EMAIL_ADDRESS_REPLYTO=$EMAIL_ADDRESS_REPLYTO_PROD
    EMAIL_ADDRESS_SENDER=$EMAIL_ADDRESS_SENDER_PROD
  else
    EMAIL_ADDRESS_APD=$EMAIL_ADDRESS_APD_STAG
    EMAIL_ADDRESS_OPO=$EMAIL_ADDRESS_OPO_STAG
    EMAIL_ADDRESS_REPLYTO=$EMAIL_ADDRESS_REPLYTO_STAG
    EMAIL_ADDRESS_SENDER=$EMAIL_ADDRESS_SENDER_STAG
  fi;


  aws lambda update-function-configuration \
        --function-name $AWS_FUNCTION_NAME \
        --environment "Variables={DEPLOYMENT_MODE=${DEPLOYMENT_MODE},KNACK_APPLICATION_ID=${KNACK_APPLICATION_ID},KNACK_API_KEY=${KNACK_API_KEY},PM_LOGTABLE=${PM_LOGTABLE},AWS_BUCKET_NAME=${AWS_BUCKET_NAME},EMAIL_ADDRESS_APD='${EMAIL_ADDRESS_APD}',EMAIL_ADDRESS_OPO='${EMAIL_ADDRESS_OPO}',EMAIL_ADDRESS_SENDER='${EMAIL_ADDRESS_SENDER}',EMAIL_ADDRESS_REPLYTO='${EMAIL_ADDRESS_REPLYTO}'}"
