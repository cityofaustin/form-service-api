...
function backend_set_env_vars {
  ...
  aws lambda update-function-configuration \
        ...
        --environment "Variables={DEPLOYMENT_MODE=${DEPLOYMENT_MODE},KNACK_APPLICATION_ID=${KNACK_APPLICATION_ID},KNACK_API_KEY=${KNACK_API_KEY},PM_LOGTABLE=${PM_LOGTABLE},AWS_BUCKET_NAME=${AWS_BUCKET_NAME},EMAIL_ADDRESS_USER='${EMAIL_ADDRESS_USER}',EMAIL_ADDRESS_APD='${EMAIL_ADDRESS_APD}',EMAIL_ADDRESS_OPO='${EMAIL_ADDRESS_OPO}'},EMAIL_ADDRESS_SENDER='${EMAIL_ADDRESS_SENDER}'},EMAIL_ADDRESS_REPLYTO='${EMAIL_ADDRESS_REPLYTO}'}"
}
